...
if (isset($_POST['submit'])) {
    if (isset($_SESSION['user_data'])) {
            if($_POST['loc']) {
            $select = "SELECT * FROM nurse WHERE n_address='" . $_POST['loc'] . "' ORDER BY n_name";
            ...
            if (mysqli_num_rows($res) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    echo '<td><div class="des"><a href="tel:' . $row['n_phone'] . '"><div class="phone"></div><img src="images/tele.jpg" width="30" height="30"></a></div></td>';
                    echo '</tr>';
                }
            } else {
